  ...
  getAllPix() {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (let i = 0; i < 128; i = i + 2) {
        ...
        _this2.i2c.write(_this2.address, [pixelAddrL]);
        let dataL = yield _this2.i2c.readWait(_this2.address, 1);
        _this2.i2c.write(_this2.address, [pixelAddrH]);
        let dataH = yield _this2.i2c.readWait(_this2.address, 1);
        let temp12bit = dataH << 8 | dataL;
        let temp = 0;
        if (dataH & 0x08) {
          // negative temperature
